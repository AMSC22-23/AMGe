...
int main (int argc, char *argv[]) {
	...
	Multigrid two(fine, PRE_SMOOTHING_STEPS, POST_SMOOTHING_STEPS, 2);
	Multigrid three(fine, PRE_SMOOTHING_STEPS, POST_SMOOTHING_STEPS, 3);
	Multigrid four(fine, PRE_SMOOTHING_STEPS, POST_SMOOTHING_STEPS, 4);
